...
TODO: apply layer rotation to the model view. This should
basically just apply a rotation to the camera, without actually
rotating it =P
TODO: replace view translation with translation of
the camera itself.
